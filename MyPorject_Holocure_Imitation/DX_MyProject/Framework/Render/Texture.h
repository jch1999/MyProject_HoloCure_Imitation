...
private:
	...
	// 싱글톤과의 제일 큰 차이점은 둘 이상의 인스터스가 만들어질 수 있다는 것으로,
	...
	// 1) 텍스쳐 하나의 용량이 상당히 클(수백 메가에서 데이터가 관리 되어있지 않다면 기가급으로 커지는 경우도 있음) 수 있는 관계로, 
	//   그런 파일이 두 개 이상의 인스턴스로 만들어지면 프로그램이 무거워질 수 밖에 없음
