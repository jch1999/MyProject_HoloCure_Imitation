...
VertexBuffer::VertexBuffer(void* data, UINT s, UINT count)
	:stride(s),offset(0)
{
	// 기존의 각 도형의 생성자에서 버퍼를 만들어서 저장했던 부분을 가져오되,
